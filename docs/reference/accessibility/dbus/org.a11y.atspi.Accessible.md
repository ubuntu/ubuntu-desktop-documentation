...
`org.a11y.atspi.Accessible.GetRole` 
    ...
    92. `ATSPI_ROLE_DOCUMENT_SPREADSHEET`
...
`org.a11y.atspi.Accessible.GetState`
    ...
    38. `ATSPI_STATE_SELECTABLE_TEXT`
