...
myst:
  html_meta:
    description: Install NVIDIA drivers on Ubuntu using the DKMS packages when you're using a custom kernel or when the standard NVIDIA packages are missing.
